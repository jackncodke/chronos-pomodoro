...
export function Settings() {
  ...
  function handleSaveSettings(e: React.SubmitEvent<HTMLFormElement>) {
    ...
    if (isNaN(workTime)) {
      formErrors.push('Informe somente números para Foco');
    }

    if (isNaN(shortBreakTime)) {
      formErrors.push('Informe somente números para Descanso Curso');
    }

    if (isNaN(longBreakTime)) {
      formErrors.push('Informe somente números para Descanso Longo');
    }
